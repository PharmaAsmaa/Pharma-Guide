const ressurser = {
  ...
  "Veiledning i apotek": {
    ...
    "Plager forårsaket av parasitter, orm & innsekter": [
      { name: "Flåttbitt.pdf", path: "Veiledning i apotek/Plager forårsaket av parasitter, orm & innsekter/Flåttbitt.pdf" },
    ...
    "Dermatosis (Hudlidelser)": [
      ...
      { name: "Munnsår (Herpes Labialis).pdf", path: "Veiledning i apotek/Dermatosis (Hudlidelser)/Munnsår (Herpes Labialis).pdf" },
